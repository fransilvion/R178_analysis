---
title: "RNAcocktail_pipeline_quality"
...
Quality control with AfterQC and BBduk (from BBMap package) tools (quality_control.sh) (Remove all # for running, except first line):
...
For running delete all comment symbols (#) except the first line (I used version 67 from ensembl website; new version 92 is available) (run_salmon.sh script): 
...
Number of common DE genes between pipelines with (clean) and without (not_clean) quality control check
